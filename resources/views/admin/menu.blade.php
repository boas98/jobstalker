...
<div class="nav-wrapper dashboard-container">
<a href="#!" class="brand-logo">Admin Page</a>
<a href="#" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">&#xE5D2;</i></a>
<ul class="right hide-on-med-and-down">
<li><a href="{{ url('admin') }}" class="waves-effect waves-light"><img src="{{ url('assets/img/admin/sample-1.jpg') }}" alt="Revando" class="pict-auth">Revando</a></li>
<li><a href="{{ url('logout') }}" class="waves-effect waves-light tooltipped" data-position="bottom" data-delay="1" data-tooltip="Keluar"><i class="material-icons">&#xE879;</i></a></li>
</ul>
</div>
</nav>
</div>
